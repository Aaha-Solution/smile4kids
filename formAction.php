    ...
    if (!empty($_POST)) {
        ...
        switch($termPrice){
            ...
            case "DofE":
                ...
                break;
            default:
                echo "This category till not added in backend";
                break;
        }
        $gender = $_POST['gender'];
        ...
        if($email_error != ''&& $password !='' && $class_id != '' && $course_id !='' && $course_Name !=''){
            ...
            $query = "INSERT INTO students 
                        (fname,surname,dob,users_type,terms,gender,parentfirstname,parentsurname,address,email,password,phone,yesorno,Stu_Sub,Stu_Cat,child_category,category,Stu_Status,DOFE) 
                        VALUES ('$stud_name','$surname','$date','$users_type','$terms','$gender','$parentFname','$parentLname','$address','$email_error','$password','$phone','$yesorno','$class_id','$course_Name','$termPrice','$course_id','Pending','$dofE')";
