            ...
            <div class="modal-content">
                ...
                <form id="saveData" class="addForm needs-validation" novalidate>
                    <div class="modal-body">
                        ...
                        <input class="form-control shadow-none" type="text" placeholder="Enter Title" name="title" id="Title" required>
                        <div class="invalid-feedback">
                            Please add Title
                        </div>

                        <label for="category" class="fw-bolder py-2">Category</label>
                        <select class="form-select shadow-none" name="category" aria-label="Default select example" required>
                        ...
                        <select class="form-select shadow-none" name="subject" aria-label="Default select example" required>
                        ...
                        <input type="text" class="datepicker form-control shadow-none" name="addDate" aria-describedby="Date" required />

                        <!-- id="upDate" -->
                        <label for="fesFol" class="fw-bolder py-2">Festival File</label>
                        <input type="file" class="form-control shadow-none" name="files" id="fesFol" placeholder="Select Date" accept="image/jpeg,image/gif,image/png,application/pdf,image" required>

                        <label for="Descriptions" class="fw-bolder py-2">Add Description</label>
                        <textarea class="form-control shadow-none" name="description" id="Descriptions" rows="2" required></textarea>
                        <div class="invalid-feedback">
            ...
            <div class="modal-content shadow p-2 rounded maindiv">
                ...
                <form id="updateData" class="needs-validation" novalidate>
                    <div class="modal-body">
                        ...
                        <select class="form-select fw-bold shadow-none" name="subject" id="subject" aria-label="Default select example" id="festivalSelectSubject" required>
                            <option value="Gujarati">Gujarati</option>
                            <option value="Hindi">Hindi</option>
                            <option value="Panjabi">Panjabi</option>
                            <option value="Spanish">Spanish</option>
                        ...
                        <textarea class="form-control shadow-none" name="description" id="description" rows="2" required></textarea>
                        <div class="invalid-feedback">
                            Please add description.
                        </div>
    ...
    <div class="modal fade viewContainer" id="dataViewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content shadow p-2 rounded maindiv">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label class="fs-5 pe-2" for="">TITLE :</label><span id="view_Title" class="fs-5 border-0"></span>
                    </div>
                    <div class="mb-3">
                        <label class="fs-5 pe-2" for="">CATEGORY NAME :</label><span id="view_Category" class="fs-5 border-0"></span>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="fs-5 pe-2" for="">TERM :</label><span id="view_Terms" class="fs-5 border-0"></span>
                    </div>
                    <div class="mb-3">
                        <label class="fs-5 pe-2" for="">FILE NAME :</label><span id="view_File" class="fs-5 border-0"></span>
                    </div>
                    <div class="mb-3 text-break">
                        <label class="fs-5 pe-2" for="">DESCRIPTION :</label><span id="view_Desc" class="fs-5 border-0"></span>
                    </div>
                </div>
                <div class="d-flex justify-content-between">
