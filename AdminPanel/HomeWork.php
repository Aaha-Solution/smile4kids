...
<head>
    ...
    <title>Smile4Kids | Homeworks</title>
</head>
...
<body>
        ...
        <div class="modal-dialog add-container shadow p-3 rounded">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="h3 text-center fw-bold">Add Homeworks<i class="fa-solid fa-book mx-2"></i></div>
                ...
                <form id="saveData" class="addForm needs-validation" novalidate enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <input type="hidden" value="Homework" name="section" />
                        ...
                        <!-- id="upDate" -->
                        <label for="fesFol" class="fw-bolder py-2">Homework Folder</label>
                        <input type="file" class="form-control shadow-none" multiple name="files[]" id="fesFol" webkitdirectory="" moxdiretory="" required>
    ...
    <div class="modal fade" id="dataEditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog updateActivityCon ">
            <div class="modal-content shadow p-2  rounded maindiv">
                <div class="modal-header">
                    <h3 class="text-center m-2"> HOMEWORK<i class="fa-solid fa-book"></i></h3>
                    <button type="button" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="updateData" class="addForm" enctype="multipart/form-data">
                    <div class="modal-body">
    ...
    <div class="modal fade viewContainer" id="dataViewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content shadow p-2 rounded maindiv">
                <div class="modal-header">
                    <div class="h3 text-center m-2"> HOMEWORK<i class="fa-solid fa-book mx-2"></i></div>
                    <button type="button" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="fs-5 pe-2" for="">Language:</label><span id="view_Language" class="fs-5 border-0"></span>
                    </div>
                    <div class="mb-3">
    ...
    <div class="body_container">
        ...
        <div class="container">
            ...
            <div class="dash_Board_Hedding ">
                <h3 class="fw-bold text-center pt-3">HOMEWORKS</h2>
            </div>
