...
<body>
    ...
    <!-- Add popup -->
    <div class="modal add-main-container justify-content-center align-items-center position-fixed" id="dataAddModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form id="saveData" class="addForm needs-validation" novalidate>
                    <div class="modal-body">
                        ...
                        <select class="form-select shadow-none" name="category" id="ebookSelectCategory" aria-label="Default select example" required>
                            <option value="PrePrep">Pre-Prep</option>
                            <option value="Junior">Junior</option>
                        </select>

                        <label for="ebookSelectSubject" class="fw-bolder py-2">Subject</label>
                        <select class="form-select shadow-none" name="subject" id="ebookSelectSubject" aria-label="Default select example" required>
                        ...
                        <div class="fw-bold fs-5">£ <input type="text" class="shadow-none border-0 rounded-pill fw-bold" style=" color: #165BAA;" value="18.99" name="eBamount" id="EbookAmount" pattern="^\d+\.{0,1}\d{0,2}$" maxlength="6" required /></div>
                        <label for="terms" class="fw-bolder py-2">Term</label>
                        <select class="form-select shadow-none" name="terms" aria-label="Default select example" required>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <button type="button" class="btn cancelBtn fw-bold shadow-none" data-bs-dismiss="modal">Cancel</button>
                            <button type="submit" class="btn ubloadBtn fw-bold shadow-none uploadBtn "><img src="./assect/logo/fileupload.gif" class=" d-none" width="20px"> Upload</button>
                        </div>
            ...
            <div class="modal-content shadow p-2  rounded maindiv">
                ...
                <form id="updateData" class="addForm needs-validation" novalidate enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <select class="form-select fw-bold shadow-none" name="category" id="category" aria-label="Default select example" id="category" required>
                            <option value="PrePrep">Pre-Prep</option>
                            <option value="Junior">Junior</option>
                        </select>
                       
                        <label for="amount" class="fw-bolder">Amount</label>
                        <div class="fw-bold">£ <input type="text" id="amount" name="amount" class="shadow-none border-0 rounded-pill fw-bold" value="18.99" pattern="^\d+\.{0,1}\d{0,2}$" maxlength="6" required /></div>
                        
                        <label for="Subject" class="fw-bolder py-2">Subject</label>
                        <select class="form-select fw-bold shadow-none" name="subject" id="subject" aria-label="Default select example" required>
                       ...
                       <div class="d-flex justify-content-between">
                            ...
                            <button type="button" class="btn shadow-none my-3 rounded fw-bold bg-success text-white" data-bs-dismiss="modal">Back</button>
                            <button type="submit" class="btn shadow-none my-3 rounded fw-bold updateBtn"><img src="./assect/logo/fileupload.gif" class=" d-none" width="20px">Click to Update</button>
                        </div>
    ...
    <!-- View popup Modal -->
    <div class="modal fade viewContainer" id="dataViewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content shadow p-2 rounded maindiv">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="fs-5 pe-2" for="">Category:</label><span id="view_Category" class="fs-5 border-0"></span>
                    </div>
                    <div class="mb-3">
                        <label class="fs-5 pe-2" for="">Subject Name:</label><span id="view_Language" class="fs-5 border-0"></span>
                    </div>
                    <div class="mb-3">
                        <label class="fs-5 pe-2" for="">Amount: £</label><span id="view_Amount" class="fs-5 border-0"></span>
                    </div>
                    <div class="mb-3">
                        <label class="fs-5 pe-2" for="">Terms:</label><span id="view_Terms" class="fs-5 border-0"></span>
                    </div>
                    <div class="mb-3">
                ...
                <div class="d-flex justify-content-between">
                    <button type="button" class="btn shadow-none my-3 btn-success rounded fw-bold viewBackBtn" data-bs-dismiss="modal">BACK</button>
    ...
    <div class="modal viewContainer" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog  updateActivityCon">
            <div class="modal-content shadow p-2 rounded maindiv">
                <div class="modal-header">
                    ...
                    <div class="m-3">
                        <form id="eBook_Amt" class="needs-validation" novalidate>
                            ...
                            <div class="input-group">
                                <div class="fw-bold text-secondary input-group-text">£ </div><input type="text" class="shadow-none form-control" style=" color: #165BAA;" name="eBamount" id="" placeholder="Enter your Offer Price" pattern="^\d+\.{0,1}\d{0,2}$" maxlength="6" required />
                                <small class="invalid-feedback">
                                    Please Enter Your Amount
                                </small>
                            </div>
                            <div class="d-flex justify-content-between">
                                <button type="button" class="btn shadow-none my-3 rounded fw-bold bg-danger text-white" data-bs-dismiss="modal">Back</button>
                                <button type="submit" class="btn shadow-none my-3 rounded fw-bold updateBtn">Click to Update</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class="body_container">
        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <div class="my-2">
                        ...
                        <input type="radio" name="subjectSelect" value="Hindi" class="subjectRadio filt" id="hindi-Hwork">
                        <label for="hindi-Hwork" class="subjectBtn my-2 fw-bold user-select-none me-1">Hindi</label>
                        <input type="radio" name="subjectSelect" value="Gujarati" class="subjectRadio filt" id="gujarati-Hwork">
                        <label for="gujarati-Hwork" class="subjectBtn my-2 fw-bold user-select-none me-1">Gujarati</label>
                        <input type="radio" name="subjectSelect" value="Panjabi" class="subjectRadio filt" id="panjabi-Hwork">
                        <label for="panjabi-Hwork" class="subjectBtn my-2 fw-bold user-select-none me-1">Panjabi</label>
            ...
            <div class="my-2 d-flex justify-content-end addContentContainer">
                <button type="button" class="btn shadow-none fw-bold px-3 float-end content-Add-Btn" data-bs-toggle="modal" data-bs-target="#dataAddModal">
                    Add
                </button>
            </div>
            ...
            <div class="d-flex justify-content-end pb-5">
                ...
                <button type="button" class="btn shadow-none fw-bold" id="changeAmount" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    Change Amount
                </button>
            </div>
        </div>
    ...
    <script>
        ...
        stuCatagory.addEventListener('change', () => {
            if (stuCatagory.value == 'PrePrep') {
                eBookAmount.value = '18.99'
            } else if (stuCatagory.value == 'Junior') {
