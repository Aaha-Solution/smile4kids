            ...
            <div class="modal-content editeStudentContainer shadow p-2  rounded maindiv">
                ...
                <div class="modal-body">
                    ...
                    <div class="my-2 mt-2 mb-2">
                        <div class="row">
                            <div class="col-sm">
                                <div class="fw-bold">NAME : <span class="view_Fname"></span> <span class="view_Sname"></span></div>
                    ...
                    <form id="updateData" class="addForm">
                        <div class="compleTermSelectCon completeTContainer">
                            ...
                            <div id='checkbox'>
                                <input type="checkbox" name="temr-1" class="form-check-input" value="Term 1" id="completeT-1">
                                <label for="completeT-1">Term 1</label>
                                <input type="checkbox" name="temr-2" class="form-check-input" value="Term 2" id="completeT-2">
                                <label for="completeT-2">Term 2</label>
                                <input type="checkbox" name="temr-3" class="form-check-input" value="Term 3" id="completeT-3">
                                <label for="completeT-3">Term 3</label>
                                <input type="checkbox" name="temr-4" class="form-check-input" value="Term 4" id="completeT-4">
                                <label for="completeT-4">Term 4</label>
                                <input type="checkbox" name="temr-5" class="form-check-input" value="Term 5" id="completeT-5">
                                <label for="completeT-5">Term 5</label>
                                <input type="checkbox" name="temr-6" class="form-check-input" value="Term 6" id="completeT-6">
                                <label for="completeT-6">Term 6</label>
                                <input type="checkbox" name="temr-7" class="form-check-input" value="Term 7" id="completeT-7">
                                <label for="completeT-7">Term 7</label>
                                <input type="checkbox" name="temr-8" class="form-check-input" value="Term 8" id="completeT-8">
                                <label for="completeT-8">Term 8</label>
                                <input type="checkbox" name="temr-9" class="form-check-input" value="Term 9" id="completeT-9">
                                <label for="completeT-9">Term 9</label>
                                <input type="checkbox" name="temr-10" class="form-check-input" value="Term 10" id="completeT-10">
                                <label for="completeT-10">Term 10</label>
                                <input type="checkbox" name="temr-11" class="form-check-input" value="Term 11" id="completeT-11">
                                <label for="completeT-11">Term 11</label>
                                <input type="checkbox" name="temr-12" class="form-check-input" value="Term 12" id="completeT-12">
                                <label for="completeT-12">Term 12</label>
                                <input type="checkbox" name="temr-13" class="form-check-input" value="Term 13" id="completeT-13">
    ...
    <div class="body_container">
        ...
        <div class="container">
            <div class="dash_Board_Hedding ">
                <h3 class="fw-bold text-center pt-3">NEW STUDENTS LIST</h2>
            </div>
           ...
           <div id="cat_btn" class="my-2">
                <input type="radio" name="stucategorytSelect" value="PrePrep" class="stucatRadio filt" id="pre-prep-cul">
            ...
            <div id="cat_btn" class=" d-flex flex-wrap justify-content-between aligin-items-center">
                <div class="d-flex aligin-items-center">
                    <div>
                        ...
                        <input type="radio" name="categorytSelect" value="Pending" class="catRadio filt" id="Pending-cul">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <div class="">
                        <button class="btn shadow-none fw-bold text-nowrap" id="pendingStuMsg" data-bs-toggle="modal" data-bs-target="#mailSentModal">Send Email</button>
                    </div>
                </div>
            </div>
                ...
                success: function(response) {
                    ...
                    if (res.status == 404) {
                        ...
                        for (var i = 0; i < arrTerms.length; i++) {
                            $('input[type="checkbox"][value="' + arrTerms[i] + '"]').prop('checked', true);
                        }
                        $('#dataEditModal').modal('show');
                    }
