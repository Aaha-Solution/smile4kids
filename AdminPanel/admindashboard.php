...
if (!isset($_SESSION)) {
    ...
    $queryde = "SELECT * FROM students WHERE DOFE = 'DofE'";
    $run_queryde = mysqli_query($connection, $queryde);
    $deScount = mysqli_num_rows($run_queryde);
...
<body>
    ...
    <div class="modal mailSendContainer" id="mailSentModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class=" modal-dialog rounded">
            <div class="modal-content shadow p-1 maindiv">
                <div class="modal-header">
                    <label for="enter maessage" class="fw-bold mb-2" style="color: #165BAA;font-size: 20px;">Send A Newsletter!</label>
                    <button type="button" class="btn-close shadow-none" data-bs-dismiss="modal"></button>
                </div>
                <form action="" method="POST" id="send" class="needs-validation p-3" novalidate enctype="multipart/form-data">
                    <label for="mailHeading" class="h5 my-2 fw-bold" style="color: #165BAA;">Title</label>
                    <input type="text" name="newsLetterHeading" id="mailHeading" class="form-control shadow-none rounded" placeholder="Enter mail title" required>
                    <label for="email_text" class="h5 my-2 fw-bold" style="color: #165BAA;">Message</label>
                    <textarea class="form-control shadow-none rounded" name="news" id="email_text" cols="50" rows="5" autofocus required></textarea>
                    <div class="d-flex justify-content-end">
                        <label for="image" class="h5 p-3 form-label d-block cursor-pointer" style="color: #165BAA;" data-bs-toggle="tooltip" data-bs-placement="top" title="Attach files">
                    ...
                    <div class="d-flex justify-content-between modal-body">
                        ...
                        <button type="button" class="btn shadow-none rounded fw-bold bg-dark text-white" data-bs-dismiss="modal">Back</button>
                        <button type="submit" value='newsletter' class="btn shadow-none bg-success text-white fw-bold uploadBtn"><img src="./assect/logo/fileupload.gif" class="me-1 pb-1 d-none" width="20px">Send</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="body_container">
        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <button class="btn shadow-none fw-bold position-relative" id="newsletter" data-bs-toggle="modal" data-bs-target="#mailSentModal">
                            Send Newsletter
               ...
               <div class="col-lg col-5 card position-relative shadow d-flex justify-content-center incom_container bg_before1 ps-3">
                    ...
                    <!--    </div>-->
                    <!--    <div>-->
                    <!--        <span class="badge bg-dark" data-bs-toggle="tooltip" data-bs-placement="bottom" title="DOFE STUDENTS"><?php echo $deScount; ?></span>-->
                    <!--    </div>-->
                    <!--</div>-->
                </div>
                <a href="HomeWork.php" class="col-lg col-5 card shadow d-flex justify-content-center incom_container bg_before2 ps-3 text-decoration-none">
                ...
                <a href="songsAdmin.php" class="col-lg col-5 card shadow d-flex justify-content-center incom_container bg_before3 ps-3 text-decoration-none">
                ...
                <a href="culturalAdmin.php" class="col-lg col-5 card shadow d-flex justify-content-center incom_container bg_before4 ps-3 text-decoration-none">
                ...
                <a href="activityAdmin.php" class="col-lg col-5 card shadow d-flex justify-content-center incom_container bg_before5 ps-3 text-decoration-none">
                ...
                <a href="E-Book.php" class="col-lg col-5 card shadow d-flex justify-content-center incom_container bg_before6 ps-3 text-decoration-none">
                        ...
                        ?>
                                ...
                                <tr class="align-middle">
                                    <td><?php echo $serialNumber; ?></td>
                                     <td class="position-relative "><?= $row['fname']; ?> <?php if ($row['DOFE'] =="DofE") {?>
                                        <img class="position-absolute pe-1 top-0 end-0" title="Duke of Edinburgh" src="./assect/dofe(gold).png" alt="" width="25px">
                                    <?php } ?></td>
                                    ...
                                    ?>
                                    <td><button type="button" class="btn fw-bold shadow-none viewBtn viewDataBtn" value="<?php echo $row['id']; ?>"><i class="fa-regular fa-eye pe-1"></i>View</button></td>
                                </tr>
                            <?php 
                                $serialNumber++;
                            }
