    ...
    <header class="admin_header">
        <div class="position-relative py-3 d-flex justify-content-between align-items-center">
            <div class="admin_dash_menu_Btn">
                <button class="btn shadow-none adminMenu_Btn"><img src="assect/logo/menuIcon.png" alt="" width="30px"></button>
            </div>
            ...
            <div class="logout_btn  d-flex justify-content-cente me-2">
                <form action="../logoutPage.php" method="POST">
                    <button type="submit" name="logout_btn" class="btn shadow-none text-decoration-none px-3 py-1 text-center fw-bold" id="logout_btn">Logout</button>
                </form>
                <div class="threDotMenu">
                    <button class="btn shadow-none" id="threDotBtn"><img src="assect/logo/menu-vertical.png" width="18px" alt=""></button>
                </div>
            </div>
        </div>
    </header>
