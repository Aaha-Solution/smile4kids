             ...
             if ($row['Stu_Status'] == 'Live') {
                if ($row['DOFE'] != 'DofE') {
                    ...
                    $output .= '<tr class="align-middle" id = row' . $row['id'] . ' >
                                    ...
                                    <td> ' . $serialNumber . '</td>
                                    <td class="position-relative">' . $row['fname'] . '<img class="position-absolute pe-1 top-0 end-0" title="Duke of Edinburgh" src="./assect/dofe(gold).png" alt="" width="25px"></td>
                                    <td>' . $row['Stu_Cat'] . '</td>
                                    <td>' . $row['Stu_Sub'] . '</td>
                                    <td>' . $dateFormat . '</td>
                                    <td class="bg-success text-white">' . $row['Stu_Status'] . '</td>
                ...
                if ($row['DOFE'] != 'DofE') {
                    ...
                    $output .= '<tr class="align-middle" id = row' . $row['id'] . ' >
                                    <td> ' . $serialNumber . '</td>
                                    <td class="position-relative">' . $row['fname'] . '<img class="position-absolute pe-1 top-0 end-0" title="Duke of Edinburgh" src="./assect/dofe(black).png" alt="" width="25px"></td>
                                    <td>' . $row['Stu_Cat'] . '</td>
                                    <td>' . $row['Stu_Sub'] . '</td>
                                    <td>' . $dateFormat . '</td>
                                    <td class="bg-danger text-white">' . $row['Stu_Status'] . '</td>
...
if (isset($_POST['condition'])) {
    ...
    $delterms = array_diff($expterms, $terms);
        ...
        $mail->Body    = '<html><body><p>Dear ' . $fname . ' ' . $lname . ',<br><br>Your account has been activated successfully. You can now login with your login credentials.<br>Email : '.$email.' <br> Password : '.$pass.'<br>' .implode(",",$recentTerm). ' has been added <br><br>Regards,<br>SMILE 4 Kids Indian Language School.<br><a href="https://smile4kids.co.uk/index" target="_blank">smile4kids.co.uk</a></p></body></html>';
    ...
    if($mailIds){
        ...
        foreach($mailIds as $id){
            ...
            if (mysqli_num_rows($run_select) > 0) {
                ...
                $mail->Subject = 'Message From SMILE 4 Kids';
                $mail->Body = '<html><body>';
                ...
                // $mail->Body    = '<html><body><p>Dear ' . $userData['fname'] . ' ' . $userData['surname'] . ',<br>'.$bodyMsg.'<br><br>Regards,<br>SMILE 4 Kids Indian Language School.<br><a href="#" target="_blank">smile4kids.uk.co</a></p></body></html>';
                $mail->AltBody = 'This is the body in plain text for non-HTML mail clients at <a href="https://smile4kids.co.uk/">Visit Smile4kids.com!</a>';
