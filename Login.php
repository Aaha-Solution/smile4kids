...
<body onload="getCookieUserdata()">
  ...
  <div class="container">
    <div class="row box_shad d-flex mt-sm-5 mb-sm-5">
      ...
      <div class="col-lg" style="background-color: #fff; padding: 10px">
         <div>
          <h1 class="header" style="font-weight: bold;">Welcome to <span style="color: #e51a22;">S</span><span style="color: #f39224;">M</span><span style="color: #f6e32f;">I</span><span style="color: #4daf47;">L</span><span style="color: #0090d7;">E</span>
            <span style="font-weight:lighter ;">4</span><span style="font-family: 'Patrick Hand', cursive;"> Kids</span>
          </h1>
        </div>
        <?php
  ...
  rememberMe.addEventListener('click', () => {
    if (rememberMe.checked != false) {
      if (!userId.value == " " && !password.value == " ") {
        ...
        document.cookie = "username=" + encodeURIComponent(uName) +"; Expires="+expiryDate +";paht=https://smile4kids.co.uk/Login";
        document.cookie = "password=" + encodeURIComponent(pwd) + "; Expires="+expiryDate +";paht=https://smile4kids.co.uk/Login";
      }
