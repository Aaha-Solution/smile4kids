...
if (isset($_GET['session_id'])) {
    ...
    //   Content
        ...
        $mail->Body    = '<html><body><p>Dear ' . $stuFname . ' ' . $stuLname . ',<br> Thank you for your purchasing,<br><br> Language : ' . $sub . '.<br>Course : ' . $cat . '.<br>Item : ' . $termname . '.<br> Price : ' . $termprice . ' <br><br>Regards,<br>SMILE 4 Kids Indian Language School.<br><a href="https://smile4kids.co.in/index" target="_blank">smile4kids.co.in</a></p></body></html>';
    ...
    // Suppress listing signed header fields in signature, defaults to true for debugging purpose
        ...
        //   Admin
            ...
            $mail->Body    = '<html><body><p><strong style = "color : #ff0000;"> ' . $stuFname . ' ' . $stuLname . '</strong>, has bought  ' . $termname . ' in ' . $course . ' - <strong>' . $lan . '</strong>.<br><strong>Contact Details</strong><br>Date of Birth : ' . $studob . '<br>Parent\'s Name : ' . $parentname . '<br> Email Address : ' . $email . '<br>Phone Number : ' . $phone . '<br><br>Regards,<br>SMILE 4 Kids Indian language School.</p></body></html>';
            $mail->AltBody = 'This is the body in plain text for non-HTML mail clients at <a href="https://smile4kids.co.uk/">Visit Smile4kids.com!</a>';
    ...
    <div id="backHomePage">
        <a href="adminstu" class="text-decoration-none">
            <div class="backHomePageChild">
                <img src="stu_assets/home-n.png" alt="back" width="30px" class="mx-2"><span class="fw-bold ps-2">Back to Home</span>
            </div>
        </a>
    </div>
              ...
              <?php  while ($row = mysqli_fetch_assoc($result)) { ?>
                        ...
                        <div class="row text-center shadow-lg mt-3  p-3 align-items-center mx-2" style="background-color: white; border-radius:10px">
                            ...
                            <div class="col-sm-4" style="align-self: center;">
                                <a href="<?php echo BASE_URL ?>AdminPanel/<?= $row['file_Path']; ?>" target="_blank" type="button" class="btn btn-dark btn-md">CLICK TO VIEW</a>
                            </div>
