...
<body>
    ...
    //     $mail->Body    = '<html><body><p>Dear ' . $stuFname.' '.$stuLname.',<br> Thank you for purchasing,<br><br> Language : ' . $lan . '.<br>Course : ' . $course . '.<br>Term : ' . $termname . ' <br>Term Price : ' . $termprice . ' <br><br>Regards,<br>SMILE 4 Kids Indian Language School.<br><a href="https://smile4kids.co.uk/index" target="_blank">smile4kids.co.uk</a></p></body></html>';
    ...
    //         $mail->Body    = '<html><body><strong style = "font-size:18px"> ' . $stuFname . ' ' . $stuLname . '</strong>, has bought  ' . $course . ' / ' . $termname . ' - <strong>' . $lan . '</strong>.<br><strong>Contact Details</strong><br>Parent\'s Name : ' . $parentname . '<br> Email Address : ' . $email . '<br>Phone Number : ' . $phone . '<br><br>Regards,<br>SMILE 4 Kids Indian Language School.</body></html>';
    ...
    <div class="termPopUpMsgMain p-2">
        <div class="termsContainer card rounded p-3">
            <form action="" method="POST" class="needs-validation" novalidate>
                <label for="select-terms" class="h5 fw-bold">Select Term</label>
                ...
                <?php
                if ($row1['Stu_Cat'] == "Junior" || $row1['Stu_Cat'] == "PrePrep") { ?>
