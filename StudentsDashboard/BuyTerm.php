...
if (isset($_POST['submit'])) {
    ...
    if ($term && $termPrice != "") {
        ...
        $cancel_url = BASE_URL . 'StudentsDashboard/BuyTerm';
        echo $success_url;
        //echo $cancel_url;
        //echo $lan;
        //echo $course;
...
<body>
    ...
    //         $mail->Body    = '<html><body><p>Dear ' . $stuFname . ' ' . $stuLname . ',<br> Thank you for purchasing,<br><br> Language : ' . $lan . '.<br>Course : ' . $course . ' <br>Term : ' . $termname . ' <br>Term Price : ' . $termprice . ' <br><br>Regards,<br>SMILE 4 Kids Indian Language School.<br><a href="https://smile4kids.co.uk/" target="_blank">smile4kids.co.uk</a></p></body></html>';
    ...
    //             $mail->Body    = '<html><body><strong style = "font-size:18px"> ' . $stuFname . ' ' . $stuLname . '</strong>, has bought  ' . $termname . ' in ' . $course . ' - <strong>' . $lan . '</strong>.<br><strong>Contact Details</strong><br>Date of Birth : ' . $studob . '<br>Parent\'s Name : ' . $parentname . '<br> Email Address : ' . $email . '<br>Phone Number : ' . $phone . '<br><br>Regards,<br>SMILE 4 Kids Indian language School.</body></html>';
    ...
    <div class="termPopUpMsgMain">
        <div class="termsContainer card rounded p-3">
            <form action="" method="POST" class="needs-validation" novalidate>
                ...
                <?php }elseif($row1['Stu_Cat'] == "PrePrep"){ ?>
                        <select class="form-select shadow-none fw-bold" name="term" aria-label="Choose Term" id="select-terms" required>
                        <option value="Term 1">Term 1 <small>(speaking)</small></option>
                        <option value="Term 2">Term 2 <small>(speaking)</small></option>
                        <option value="Term 3">Term 3 <small>(speaking)</small></option>
